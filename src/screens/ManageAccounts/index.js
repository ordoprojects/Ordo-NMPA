...
const ManageAccounts = ({ navigation }) => {
    ...
    const FetchMaintanaData = async () => {
        ...
        await fetch("https://gsidev.ordosolution.com/api/bank_account/", requestOptions)
        ...
        <TouchableOpacity onPress={() => { navigation.navigate("AddAccount", { screen: 'edit', details: item }) }}>
            <View style={styles.item}>
                ...
                <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: 'center' }}>
                    ...
                    <Text
                        style={{ fontSize: 15, fontFamily: "AvenirNextCyr-Medium", color: Colors.primary }}
                    >
                        {item.ifsc_code}
                    </Text>
                </View>
        ...
        >
          ...
          >
            ...
            <View style={styles.whiteView}>
                ...
                {loading ? (
                    <LoadingView visible={loading} message="Loading ..." />
                ) : (
                    <FlatList
                        data={
                            maintenanceData
