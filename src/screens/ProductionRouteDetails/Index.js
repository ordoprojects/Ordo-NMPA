...
const ProductionRouteDetails = ({ navigation, route }) => {
    ...
    Alert.alert(
      ...
      [
       ...
       text: "Yes",
        ...
        fetch(
          `https://gsidev.ordosolution.com/api/production_pickup_status/${routeDetails?.id}/`,
          requestOptions
        )
  ...
  const DeliveryRoutStatus = () => {
    ...
    Alert.alert(
      ...
      [
        ...
        fetch(
          "https://gsidev.ordosolution.com/api/production_order_update/",
          requestOptions
        )
          .then((response) => response.json())
          .then((result) => {
                                  ...
                                  <View style={{ marginTop: 10 }}>
                                    ...
                                    {item.product_list?.map((product, index) => (
                                      <View key={product.id} style={{ marginBottom: index !== item.product_list.length - 1 ? 10 : 0 }}>
                                        <Text style={{ color: Colors.primary, fontSize: 13, fontFamily: 'AvenirNextCyr-Bold', marginLeft: '1%' }}>
                                          {product?.name}
                                        </Text>
                                        {product?.name !== "BASE PLATE" && (
                                        <Text style={{ color: Colors.black, fontSize: 14, fontFamily: 'AvenirNextCyr-Bold', marginTop: 10 }}>Total Weight: {product?.roofing_loaded_weight} Kg</Text>
                                         )}
                                        <Text style={{ color: Colors.black, fontSize: 14, fontFamily: 'AvenirNextCyr-Bold', marginTop: 10 }}>Production Dimensions:</Text>
                                        {product.production_orders?.map((order, orderIndex) => (
                                          <View key={orderIndex} style={{ marginLeft: '2%', marginTop: 5 }}>
                                           
                                            <Text style={{ color: Colors.black, fontSize: 13, fontFamily: 'AvenirNextCyr-Bold' }}>Dimensions: 
                                            {product?.name === "BASE PLATE" ? (
                                                  <Text
                                                    style={{
                                                      color: Colors.black,
                                                  ...
                                                  >
                                                    {" "}
                                                    {order.height_inch} X {order.width_ft} X {" "}
                                                    {order.thickness ? order.thickness : "0"} MM
                                                  </Text>
                                                ) : (
                                                  <Text
                                                    style={{
                                                  ...
                                                  >
                                                    {" "}
                                                    {order.width_ft}' {order.height_inch}''
                                                  </Text>
                                                )}
                                            </Text>
                                            {product?.name === "BASE PLATE" &&(
                                            <Text style={{ color: Colors.black, fontSize: 13, fontFamily: 'AvenirNextCyr-Medium' }}>
                                              <Text style={{ color: Colors.black, fontSize: 13, fontFamily: 'AvenirNextCyr-Bold' }}>Loaded Weight:</Text> {order?.base_loaded_weight} Kg
                                            </Text>
                                            )}
                                            <Text style={{ color: Colors.black, fontSize: 13, fontFamily: 'AvenirNextCyr-Medium' }}>
                                              <Text style={{ color: Colors.black, fontSize: 13, fontFamily: 'AvenirNextCyr-Bold' }}>Loaded Qty:</Text> {order?.loaded_qty} NOS
                                            </Text>
                                            {order.remaining_nos === '0.00' && 
                                            <Text style={{ color: Colors.black, fontSize: 13, fontFamily: 'AvenirNextCyr-Medium' }}>
                                              <Text style={{ color: Colors.black, fontSize: 13, fontFamily: 'AvenirNextCyr-Bold' }}>Remaining Qty:</Text> {order.remaining_nos}
                                            </Text>
                                             }
                                          </View>
                                        ))}
...
export default ProductionRouteDetails;
