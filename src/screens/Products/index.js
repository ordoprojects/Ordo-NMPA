...
const Products = ({ navigation, visible, extended, label, animateFrom }) => {
          ...
          : `https://gsidev.ordosolution.com${item.product_image}`,
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {/*   
                      <View style={{ backgroundColor: '#E4E4E4', justifyContent: 'center', alignItems: 'center',  borderRadius: 5, padding:4 }}>
                        <AntDesign
                          name={"edit"}
                          size={18}
                          onPress={() =>
                            navigation.navigate("MerchAddProduct", { item: item })
                          }
                        />
                      </View>
                      ...
                      <View style={{ backgroundColor: '#fbd9d3', justifyContent: 'center', alignItems: 'center', borderRadius: 5, padding:4 }}>
                        <Feather
                          name={"trash-2"}
                          color={"tomato"}
                          size={18}
