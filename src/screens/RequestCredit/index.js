...
const RequestCredit = ({ navigation, route }) => {
    ...
    return (
        <View style={{ flex: 1, backgroundColor: 'white' }}>
            <View style={{ ...styles.headercontainer }}>
                ...
                <Text style={styles.headerTitle}>Credit Approval Request</Text>
            </View>
            <View style={{ paddingHorizontal: 16, flex: 1 }}>
                ...
                <View>
                    <Text style={styles.modalTitle}>Credit Amt</Text>
                    <TextInput style={styles.cNameTextInput} placeholder='Credit Amt'
