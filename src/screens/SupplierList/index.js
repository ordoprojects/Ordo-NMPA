...
const SupplierList = ({ navigation, route, visible,
    extended,
    label,
    animateFrom, }) => {
    ...
    const resetHeader = () => {
        navigation.setOptions({
            headerTitle: <Text style={styles.headerTitle}>Suppliers</Text>,
        });
    };
            ...
            >
              ...
              />
                        ...
                        {isSelected && <View style={{ position: 'absolute', right: 0 }}>
                            <AntDesign name='checkcircle' size={23} color={Colors.primary} />
                        </View>}
                    </View>
                    <View style={{
                        flex: 1,
